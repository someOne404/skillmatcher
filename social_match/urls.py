...
urlpatterns = [
    ...
    url(r'^search/$',
        FilterView.as_view(filterset_class=UserFilter,
                           template_name='social_match/search.html'),
        name='search'),
    ...
    path("api/major-autocomplete/",
         views.MajorAutocomplete.as_view(),
         name='major-autocomplete'),
    path("api/minor-autocomplete/",
         views.MinorAutocomplete.as_view(),
         name='minor-autocomplete'),
    path("api/course-autocomplete/",
         views.CourseAutocomplete.as_view(),
         name='course-autocomplete'),
    path("api/skill-autocomplete/",
         views.SkillAutocomplete.as_view(model=Skill, create_field='name'),
         name='skill-autocomplete'),
    path("api/activity-autocomplete/",
         views.ActivityAutocomplete.as_view(model=Activity,
                                            create_field='name'),
         name='activity-autocomplete'),
    path("api/interest-autocomplete/",
         views.InterestAutocomplete.as_view(model=Interest,
                                            create_field='name'),
         name='interest-autocomplete'),

    # separate paths for autocomplete without option to create (for searching)
    path("api/skill-autocomplete-search/",
         views.SkillAutocomplete.as_view(model=Skill),
         name='skill-search'),
    path("api/activity-autocomplete-search/",
         views.ActivityAutocomplete.as_view(model=Activity),
         name='activity-search'),
    path("api/interest-autocomplete-search/",
         views.InterestAutocomplete.as_view(model=Interest),
